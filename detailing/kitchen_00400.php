...
<form class="detailing-form step">
	<fieldset class="detailing-form-fieldset">
		...
		<label class="detailing-form-input-label">
			<input onkeydown="if(event.keyCode==13){return false;}" name="UGLprv000" value="closely" type="radio" class="radio-button<?php echo $b41; ?>" />
		...
		<label class="detailing-form-input-label">
			<input onkeydown="if(event.keyCode==13){return false;}" name="UGLprv000" value="separately" type="radio" class="radio-button<?php echo $b42; ?>" />
