...
<form class="detailing-form step">
	<fieldset class="detailing-form-fieldset">
		<div class="instruction">
			...
			<p class="instruction-p">Вы уже знаете, что делать. Всё, как и в предыдущих трёх случаях.</p>
		...
		<label class="detailing-form-input-label">
			<input onkeydown="if(event.keyCode==13){return false;}" name="UGLprv001" value="closely" type="radio" class="radio-button<?php echo $b411; ?>" />
		...
		<label class="detailing-form-input-label">
			<input onkeydown="if(event.keyCode==13){return false;}" name="UGLprv001" value="separately" type="radio" class="radio-button<?php echo $b412; ?>" />
