...
<form class="detailing-form step">
	<fieldset class="detailing-form-fieldset">
		...
		<label class="detailing-form-input-label">
			<input onkeydown="if(event.keyCode==13){return false;}" name="MODrsp000" value="linear" type="radio" class="radio-button<?php echo $b21; ?>" />
		...
		<label class="detailing-form-input-label">
			<input onkeydown="if(event.keyCode==13){return false;}" name="MODrsp000" value="parallel" type="radio" class="radio-button<?php echo $b22; ?>" />
		...
		<label class="detailing-form-input-label">
			<input onkeydown="if(event.keyCode==13){return false;}" name="MODrsp000" value="insular" type="radio" class="radio-button<?php echo $b23; ?>" />
		...
		<label class="detailing-form-input-label">
			<input onkeydown="if(event.keyCode==13){return false;}" name="MODrsp000" value="L" type="radio" class="radio-button<?php echo $b24; ?>" />
			<img src="/detailing/images/MODrsp000_4.png" alt="угловое" class="radio-image" />
			<span class="detailing-form-input-span">угловое</span>
		</label>
		<label class="detailing-form-input-label">
			<input onkeydown="if(event.keyCode==13){return false;}" name="MODrsp000" value="U" type="radio" class="radio-button<?php echo $b25; ?>" />
		...
		<label class="detailing-form-input-label">
			<input onkeydown="if(event.keyCode==13){return false;}" name="MODrsp000" value="G" type="radio" class="radio-button<?php echo $b26; ?>" />
