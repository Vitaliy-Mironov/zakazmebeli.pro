...
// записываем в переменную $a варианты расположения кухни
...
<form class="detailing-form step">
	<fieldset class="detailing-form-fieldset">
		<div class="instruction">
			...
			<p class="instruction-p">Если левый край<?php if ($_SESSION["MODrsp000"] == "parallel") { echo ' первого ряда "параллельной"';} ?> кухни не будет упираться в стену (например, если там будет расположен отдельностоящий холодильник, газовая плита, другая не встраиваемая техника или свободное пространство), - отметьте "отдельно".</p>
		...
		<label class="detailing-form-input-label">
			<input onkeydown="if(event.keyCode==13){return false;}" name="UGLlev000" value="separately" type="radio" class="radio-button<?php echo $b31; ?>" />
		...
		<label class="detailing-form-input-label">
			<input onkeydown="if(event.keyCode==13){return false;}" name="UGLlev000" value="closely" type="radio" class="radio-button<?php echo $b32; ?>" />
