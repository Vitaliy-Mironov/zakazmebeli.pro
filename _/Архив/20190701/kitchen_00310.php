...
<form class="detailing-form step">
	<fieldset class="detailing-form-fieldset">
		...
		<label class="detailing-form-input-label">
			<input onkeydown="if(event.keyCode==13){return false;}" name="UGLlev001" value="separately" type="radio" class="radio-button<?php echo $b311; ?>" />
		...
		<label class="detailing-form-input-label">
			<input onkeydown="if(event.keyCode==13){return false;}" name="UGLlev001" value="closely" type="radio" class="radio-button<?php echo $b312; ?>" />
