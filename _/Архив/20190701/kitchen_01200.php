...
if (!empty($_REQUEST["ZFVtop000"])) {$b125 = $_REQUEST["ZFVtop000"];} elseif (!empty($_SESSION["ZFVtop000"])) {$b125 = $_SESSION["ZFVtop000"];} else {$b125 = "3.0";}
...
<form class="detailing-form step">
	<fieldset class="detailing-form-fieldset">
		...
		<legend class="headline"><?php echo $formcount.'. '; ?>Верхние зазоры</legend>
