...
<form class="detailing-form step">
	<fieldset class="detailing-form-fieldset">
		<div class="direction">
			...
			<p class="direction-p">Так как форма расположения кухни - параллельная, то проделываем те же действия и со вторым, параллельным рядом:</p>
			<p class="direction-p">Если левый край второго ряда "параллельной" кухни не будет упираться в стену (например, если там будет расположен отдельностоящий холодильник, газовая плита, другая не встраиваемая техника или свободное пространство), - отметьте "отдельно".</p>
