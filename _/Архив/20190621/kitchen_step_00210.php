...
<form class="detailing-form step">
	<fieldset class="detailing-form-fieldset">
		<div class="direction">
			...
			<p class="direction-p">G-образная форма кухни очень специфична. Какой из этих вариантов больше подходит в Вашем случае?</p>
		...
		<label class="detailing-form-input-label">
			<input name="MODrsp001" value="ordinary" type="radio" class="radio-button<?php echo $b211; ?>" />
			<img src="/detailing/images/MODrsp000_6.png" alt="обычная" class="radio-image" />
			<span class="detailing-form-input-span">обычная</span>
		</label>
		<label class="detailing-form-input-label">
			<input name="MODrsp001" value="reflection" type="radio" class="radio-button<?php echo $b212; ?>" />
