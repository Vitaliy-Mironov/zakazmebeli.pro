...
if (empty($_SESSION["colortheme"])) {$_SESSION["colortheme"] = "LightSlateGray";}
...
if($_REQUEST["MBLvid000"] == "kitchen") {$b11 = " checked";} elseif ($_SESSION["MBLvid000"] == "kitchen") {$b11 = " checked";}
if($_REQUEST["MBLvid000"] == "table") {$b12 = " checked";} elseif ($_SESSION["MBLvid000"] == "table") {$b12 = " checked";}
if($_REQUEST["MBLvid000"] == "casecompartment") {$b13 = " checked";} elseif ($_SESSION["MBLvid000"] == "casecompartment") {$b13 = " checked";}
if($_REQUEST["MBLvid000"] == "commode") {$b14 = " checked";} elseif ($_SESSION["MBLvid000"] == "commode") {$b14 = " checked";}
...
<form class="detailing-form step">
	<fieldset class="detailing-form-fieldset">
		<div class="direction">
			...
			<p class="direction-p">Выберете нужный вариант и жмите "Применить". Программа обработает отправленные Вами данные, и, на их основании, предложит следующий шаг...</p>
			<p class="direction-p">На данный момент возможен только вариант выбора "кухня". Выбор другого вида мебели будет доступен позже.</p>
		...
		<label class="detailing-form-input-label">
			<input name="MBLvid000" value="kitchen" type="radio" class="radio-button<?php echo $b11; ?>" />
			<img src="/detailing/images/MBLvid000_1.png" alt="кухня" class="radio-image" />
			<span class="detailing-form-input-span">кухня</span>
		</label>
		<label class="detailing-form-input-label">
			<input name="MBLvid000" value="table" type="radio" class="radio-button<?php echo $b12; ?>" disabled />
			<img src="/detailing/images/MBLvid000_2.png" alt="стол" class="radio-image" />
			<span class="detailing-form-input-span">стол</span>
		</label>
		<label class="detailing-form-input-label">
			<input name="MBLvid000" value="casecompartment" type="radio" class="radio-button<?php echo $b13; ?>" disabled />
		...
		<label class="detailing-form-input-label">
			<input name="MBLvid000" value="commode" type="radio" class="radio-button<?php echo $b14; ?>" disabled />
...
<form class="detailing-form meter">
	<button name="unsess" value="unsess" type="submit" formaction="" formmethod="post" class="detailing-button cleaning-button"></button>
</form>
<?php
echo '<hr />'."\n";
