...
if(!empty($_REQUEST["MATfas000"])) {$b81 = $_REQUEST["MATfas000"];} elseif (!empty($_SESSION["MATfas000"])) {$b81 = $_SESSION["MATfas000"];} else {$b81 = "16";}
if(!empty($_REQUEST["MATmod000"])) {$b82 = $_REQUEST["MATmod000"];} elseif (!empty($_SESSION["MATmod000"])) {$b82 = $_SESSION["MATmod000"];} else {$b82 = "16";}
if(!empty($_REQUEST["MATbox000"])) {$b83 = $_REQUEST["MATbox000"];} elseif (!empty($_SESSION["MATbox000"])) {$b83 = $_SESSION["MATbox000"];} else {$b83 = "16";}
if(!empty($_REQUEST["KRMfas000"])) {$b81k = $_REQUEST["KRMfas000"];} elseif (!empty($_SESSION["KRMfas000"])) {$b81k = $_SESSION["KRMfas000"];} else {$b81k = "2.00";}
if(!empty($_REQUEST["KRMmod000"])) {$b82k = $_REQUEST["KRMmod000"];} elseif (!empty($_SESSION["KRMmod000"])) {$b82k = $_SESSION["KRMmod000"];} else {$b82k = "2.00";}
if(!empty($_REQUEST["KRMbox000"])) {$b83k = $_REQUEST["KRMbox000"];} elseif (!empty($_SESSION["KRMbox000"])) {$b83k = $_SESSION["KRMbox000"];} else {$b83k = "2.00";}
...
<form class="detailing-form step">
	<fieldset class="detailing-form-fieldset">
		...
		<div class="detailing-form-input-div">
			...
			Толщина фасадов (мм): <input name="MATfas000" type="number" class="textnumber underline" pattern="[0-9]" min="1" max="50" value="<?php echo $b81; ?>" required />
			</label>
		</div>
		<div class="detailing-form-input-div">
			<label class="textlabel big">
			Кромка фасадов (мм): <input name="KRMfas000" type="text" class="textnumber underline" pattern="[0-9]{1}.[0-9]{2}" min="0.00" max="2.00" value="<?php echo $b81k; ?>" required />
			</label>
		</div>
		<hr class="line" />
		<div class="illustration">
		...
		<div class="detailing-form-input-div">
			<label class="textlabel big">
			Толщина модулей (мм): <input name="MATmod000" type="number" class="textnumber underline" pattern="[0-9]" min="1" max="50" value="<?php echo $b82; ?>" required />
			</label>
		</div>
		<div class="detailing-form-input-div">
			<label class="textlabel big">
			Кромка модулей (мм): <input name="KRMmod000" type="text" class="textnumber underline" pattern="[0-9]{1}.[0-9]{2}" min="0.00" max="2.00" value="<?php echo $b82k; ?>" required />
			</label>
		</div>
		<hr class="line" />
		<div class="illustration">
		...
		<div class="detailing-form-input-div">
			<label class="textlabel big">
			Толщина ящиков (мм): <input name="MATbox000" type="number" class="textnumber underline" pattern="[0-9]" min="1" max="50" value="<?php echo $b83; ?>" required />
			</label>
		</div>
		<div class="detailing-form-input-div">
			<label class="textlabel big">
			Кромка ящиков (мм): <input name="KRMbox000" type="text" class="textnumber underline" pattern="[0-9]{1}.[0-9]{2}" min="0.00" max="2.00" value="<?php echo $b83k; ?>" required />
			</label>
		</div>
		<input name="MATfmb000" type="text" class="hidden" value="ok" /> <!-- контролька -->
	</fieldset>
	<a id="MATfmb000"></a>
