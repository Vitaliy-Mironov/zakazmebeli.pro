...
<form class="detailing-form step">
	<fieldset class="detailing-form-fieldset">
		<div class="instruction">
			...
			<p class="instruction-p"><a href="kak-pravilno-izmerit-razmery-pod-kuhnyu.php" class="instruction-p-link icon-doc">Как правильно измерить размеры под кухню, и какие моменты учесть?</a></p>
...
switch ($_SESSION["UGLxzx000"]) {
	case "ok":
		require 'kitchen_step_00800.php';
		break;
}
?>