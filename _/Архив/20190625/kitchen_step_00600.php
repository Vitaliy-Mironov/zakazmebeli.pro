...
<form class="detailing-form step">
	<fieldset class="detailing-form-fieldset">
		<div class="instruction">
			...
			<p class="instruction-p">Вводить числа нужно в формате XX.X или XXX.X с точкой в качестве разделителя. Например: 90.0 или 89.7 или 101.2</p>'."\n";}
			?>
			<p class="instruction-p"><a href="kak-pravilno-izmerit-ugol.php" class="instruction-p-link icon-doc">Как правильно измерить угол?</a></p>
			<p class="instruction-p"><a href="kak-izmerit-ugol-bez-uglomera.php" class="instruction-p-link icon-doc">Как измерить угол без угломера?</a></p>
