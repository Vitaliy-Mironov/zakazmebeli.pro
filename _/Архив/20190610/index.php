...
.detailing-form-note-checkbox {position: relative; left: 40px; display: inline-block; outline: none; padding: 10px;}
.detailing-form-note-checkbox::before {position: relative; left: -20px; top: -3px; display: inline-block; width: 20px; height: 20px; background-color: white; border: 1px solid <?php echo $colortheme; ?>; border-radius: 50%; cursor: pointer; outline: none; color: <?php echo $colortheme; ?>; text-align: center; font-size: 16px; padding: 10px; font-weight: bold; content: "i"; transition: 0.5s;}
.detailing-form-note-checkbox:checked::before {content: "x"; font-weight: normal; transition: 0.5s;}
.detailing-form-note-checkbox:checked:hover::before,
.detailing-form-note-checkbox:hover::before {background-color: <?php echo $colortheme; ?>; color: white; transition: 0.5s;}
.detailing-form-note-checkbox:checked ~ .detailing-form-note-p {display: block;}
